...
int main() {
  ...
  std::cout << "r1.area() => " << r1.area() << "; r1.perimeter() => "
  ...
  std::cout << "r2.area() => " << r2.area() << "; r2.perimeter() => "
            << r2.perimeter() << std::endl;
  std::cout << std::endl;

  std::cout << "r1.get_vertex(0) => " << r1.get_vertex(0)
            << "; r1[0] => " << r1[0] << std::endl;
  std::cout << "r1.get_vertex(3) => " << r1.get_vertex(3)
            << "; r1[3] => " << r1[3] << std::endl;
  std::cout << std::endl;
  ...
  try {
    ...
    std::cout << "r2.set_vertices(...) => std::invalid_argument: "
              << e.what() << std::endl;
  }
  std::cout << std::endl;
